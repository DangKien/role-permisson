...
trait RolePerUserTrait
{
    ...
    public function cachedRoles()
    {
        ...
        $cacheKey = 'roleper_roles_for_user_'.$this->$userPrimaryKey;
        if(Cache::getStore() instanceof TaggableStore) {
            return Cache::tags(Config::get('roleper.role_user_table'))->remember($cacheKey, Config::get('cache.ttl'), function () {
    ...
    {   //both inserts and updates
        if(Cache::getStore() instanceof TaggableStore) {
            Cache::tags(Config::get('roleper.role_user_table'))->flush();
        }
    ...
    {
        return $this->belongsToMany(Config::get('roleper.role'), Config::get('roleper.role_user_table'), Config::get('roleper.user_foreign_key'), Config::get('roleper.role_foreign_key'));
    }
